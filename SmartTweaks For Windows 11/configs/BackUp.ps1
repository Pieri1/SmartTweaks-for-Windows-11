...
Set-ItemProperty -Path 'HKCU:\Software\Microsoft\Windows\CurrentVersion\Explorer\Advanced' -Name 'TaskbarBadges' -Type DWord -Value 0
...
Set-ItemProperty -Path 'HKCU:\Control Panel\Accessibility\Keyboard Preference' -Name 'On' -Type DWord -Value 0
Set-ItemProperty -Path 'HKCU:\Software\Microsoft\Windows\CurrentVersion\Explorer\ControlPanel' -Name 'StartupPage' -Type DWord -Value 0
